...
def spherical_interpolator_from_mesh(
    ...
    Args:
        ...
        use_embree: Use an alternative algorithm that uses embree CPU raytracing. Defaults to True only if embree is available;
            it requires Intel architecture.
    ...
    if use_embree:
        ...
        return _spherical_interpolator_from_mesh_original(surface_mesh_transformed, dist_tolerance)

def _spherical_interpolator_from_mesh_original(surface_mesh : vtk.vtkPolyData, dist_tolerance:float) -> Callable:
